export default {
  id: 'hero-dva-l7-mistakes',
  pathId: 'hero-dva',
  title: 'D.Va: Common Mistakes',
  subtitle: 'Recognising and fixing habits that hold D.Va players back',
  difficulty: 4,
  xp: 60,
  estimatedMinutes: 7,
  content: [
    {
      type: 'text',
      body: 'Even experienced D.Va players fall into repeated patterns. Identifying these habits is the first step to eliminating them.',
    },
    {
      type: 'callout',
      variant: 'warning',
    ...
    },
    {
      ...
      body: 'Using Boosters reactively instead of proactively reduces its impact. Plan ahead — cooldowns used at the wrong moment leave you defenceless.',
    },
    {
      type: 'callout',
      variant: 'warning',
      title: 'Mistake 3: Holding Ultimate Too Long',
      body: 'Waiting for the perfect Self-Destruct moment often means never using it. Frequent average ultimates outperform rare perfect ones over an entire match.',
    },
    {
      type: 'callout',
      variant: 'warning',
    ...
    },
    {
      ...
      body: 'Most D.Va mistakes are amplified when playing silently. Calling out ability status, ultimate charge, and threats lets teammates fill gaps you leave.',
    },
  ],
  quiz: {
    passMark: 0.75,
    questions: [
      ...
      },
      {
        ...
        options: [
          { id: 'a', text: 'Play D.Va identically regardless.' },

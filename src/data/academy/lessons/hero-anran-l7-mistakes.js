export default {
  id: 'hero-anran-l7-mistakes',
  pathId: 'hero-anran',
  title: 'Anran: Common Mistakes',
  subtitle: 'Recognising and fixing habits that hold Anran players back',
  difficulty: 5,
  xp: 60,
  estimatedMinutes: 7,
  content: [
    {
      type: 'text',
      body: 'Even experienced Anran players fall into repeated patterns. Identifying these habits is the first step to eliminating them.',
    },
    {
      type: 'callout',
      variant: 'warning',
    ...
    },
    {
      ...
      body: 'Using Fan the Flames reactively instead of proactively reduces its impact. Plan ahead — cooldowns used at the wrong moment leave you defenceless.',
    },
    {
      type: 'callout',
      variant: 'warning',
      title: 'Mistake 3: Holding Ultimate Too Long',
      body: 'Waiting for the perfect Vermillion Ascent / Vermillion Revival moment often means never using it. Frequent average ultimates outperform rare perfect ones over an entire match.',
    },
    {
      type: 'callout',
      variant: 'warning',
    ...
    },
    {
      ...
      body: 'Most Anran mistakes are amplified when playing silently. Calling out ability status, ultimate charge, and threats lets teammates fill gaps you leave.',
    },
  ],
  quiz: {
    passMark: 0.75,
    questions: [
      ...
      },
      {
        ...
        options: [
          { id: 'a', text: 'Play Anran identically regardless.' },

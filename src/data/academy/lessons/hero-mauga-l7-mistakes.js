export default {
  id: 'hero-mauga-l7-mistakes',
  pathId: 'hero-mauga',
  title: 'Mauga: Common Mistakes',
  subtitle: 'Recognising and fixing habits that hold Mauga players back',
  difficulty: 5,
  xp: 60,
  estimatedMinutes: 7,
  content: [
    {
      type: 'text',
      body: 'Even experienced Mauga players fall into repeated patterns. Identifying these habits is the first step to eliminating them.',
    },
    {
      type: 'callout',
      variant: 'warning',
    ...
    },
    {
      ...
      body: 'Using Overrun reactively instead of proactively reduces its impact. Plan ahead — cooldowns used at the wrong moment leave you defenceless.',
    },
    {
      type: 'callout',
      variant: 'warning',
      title: 'Mistake 3: Holding Ultimate Too Long',
      body: 'Waiting for the perfect Cage Fight moment often means never using it. Frequent average ultimates outperform rare perfect ones over an entire match.',
    },
    {
      type: 'callout',
      variant: 'warning',
    ...
    },
    {
      ...
      body: 'Most Mauga mistakes are amplified when playing silently. Calling out ability status, ultimate charge, and threats lets teammates fill gaps you leave.',
    },
  ],
  quiz: {
    passMark: 0.75,
    questions: [
      ...
      },
      {
        ...
        options: [
          { id: 'a', text: 'Play Mauga identically regardless.' },

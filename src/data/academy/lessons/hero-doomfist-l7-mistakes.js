export default {
  id: 'hero-doomfist-l7-mistakes',
  pathId: 'hero-doomfist',
  title: 'Doomfist: Common Mistakes',
  subtitle: 'Recognising and fixing habits that hold Doomfist players back',
  difficulty: 5,
  xp: 60,
  estimatedMinutes: 7,
  content: [
    {
      type: 'text',
      body: 'Even experienced Doomfist players fall into repeated patterns. Identifying these habits is the first step to eliminating them.',
    },
    {
      type: 'callout',
      variant: 'warning',
    ...
    },
    {
      ...
      body: 'Using Rocket Punch reactively instead of proactively reduces its impact. Plan ahead — cooldowns used at the wrong moment leave you defenceless.',
    },
    {
      type: 'callout',
      variant: 'warning',
      title: 'Mistake 3: Holding Ultimate Too Long',
      body: 'Waiting for the perfect Meteor Strike moment often means never using it. Frequent average ultimates outperform rare perfect ones over an entire match.',
    },
    {
      type: 'callout',
      variant: 'warning',
      title: 'Mistake 4: Not Adapting to Counters',
      body: 'If Orisa is on the enemy team, adjust your positioning and cooldown usage. Continuing the same approach into a counter is a losing pattern.',
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'The Fix: Communication',
      body: 'Most Doomfist mistakes are amplified when playing silently. Calling out ability status, ultimate charge, and threats lets teammates fill gaps you leave.',
    },
  ],
  quiz: {
    passMark: 0.75,
    questions: [
      ...
      {
        id: 'q3',
        text: 'How should you respond when Orisa is on the enemy team?',
        options: [
          { id: 'a', text: 'Play Doomfist identically regardless.' },
